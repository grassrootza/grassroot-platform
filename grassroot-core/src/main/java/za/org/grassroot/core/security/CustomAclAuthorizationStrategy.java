 ...
 */
public class CustomAclAuthorizationStrategy implements AclAuthorizationStrategy {
    ...
    public void securityCheck(Acl acl, int changeType) {
        ...
        Collection<? extends GrantedAuthority> currentUserGrantedAuthorities = authentication.getAuthorities();

        for(GrantedAuthority grantedAuthority:currentUserGrantedAuthorities)
        {
            if(grantedAuthority.getAuthority().equals(grantedAuthority.getAuthority()))
            {
                return;
            }
        }
