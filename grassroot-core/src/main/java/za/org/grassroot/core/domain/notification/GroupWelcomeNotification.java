...
public class GroupWelcomeNotification extends AccountNotification {
    ...
    public User getSender() {
        User logCreator = getAccountLog().getUser();
        // because sometimes these are generated by user themselves (e.g., on joining), and don't want to send someone
        // a message from themself ...
        return logCreator == null || logCreator.equals(getTarget()) ? null : logCreator;
    }
