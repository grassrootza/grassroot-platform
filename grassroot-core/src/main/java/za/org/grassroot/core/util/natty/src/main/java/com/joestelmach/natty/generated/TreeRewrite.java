// $ANTLR 3.5.2 com/joestelmach/natty/generated/TreeRewrite.g 2016-04-09 18:23:08
...
public class TreeRewrite extends TreeRewriter {
	...
	@Override public String getGrammarFileName() { return "com/joestelmach/natty/generated/TreeRewrite.g"; }
	...
	// $ANTLR start "topdown"
	// com/joestelmach/natty/generated/TreeRewrite.g:32:1: topdown : ( ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH INT ) ^( DAY_OF_MONTH dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) amount= INT ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY $amount ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT SPAN amt= INT span= SPAN ) -> ^( SEEK DIRECTION SEEK_BY $amt $span) | ^( RELATIVE_DATE ^( SEEK dir= DIRECTION seekby= SEEK_BY day= INT ^( MONTH_OF_YEAR month= INT ) ) ^( EXPLICIT_SEEK amount= INT ^( DAY_OF_WEEK dow= INT ) ) ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) ) -> ^( RELATIVE_DATE ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) ) ^( EXPLICIT_SEEK ^( YEAR_OF $year) ) ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) ) ) );
	@Override
	public final TreeRewrite.topdown_return topdown() throws RecognitionException {
		...
		try {
			// com/joestelmach/natty/generated/TreeRewrite.g:33:3: ( ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH INT ) ^( DAY_OF_MONTH dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) amount= INT ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY $amount ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT SPAN amt= INT span= SPAN ) -> ^( SEEK DIRECTION SEEK_BY $amt $span) | ^( RELATIVE_DATE ^( SEEK dir= DIRECTION seekby= SEEK_BY day= INT ^( MONTH_OF_YEAR month= INT ) ) ^( EXPLICIT_SEEK amount= INT ^( DAY_OF_WEEK dow= INT ) ) ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) ) -> ^( RELATIVE_DATE ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) ) ^( EXPLICIT_SEEK ^( YEAR_OF $year) ) ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) ) ) )
			int alt1=6;
			...
			switch (alt1) {
				case 1 :
					// com/joestelmach/natty/generated/TreeRewrite.g:33:5: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) )
					{
					...
					// AST REWRITE
					// elements: DAY_OF_WEEK, dow, SEEK, INT, DIRECTION, SEEK_BY
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
					...
					{
						// com/joestelmach/natty/generated/TreeRewrite.g:34:10: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) )
						{
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:34:39: ^( DAY_OF_WEEK $dow)
						{
					...
					break;
				case 2 :
					// com/joestelmach/natty/generated/TreeRewrite.g:36:5: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH INT ) ^( DAY_OF_MONTH dow= INT ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: DIRECTION, DAY_OF_MONTH, dow, SEEK_BY, INT, SEEK
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
					...
					{
						// com/joestelmach/natty/generated/TreeRewrite.g:37:10: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH $dow) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:37:39: ^( DAY_OF_MONTH $dow)
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
					...
					break;
				case 3 :
					// com/joestelmach/natty/generated/TreeRewrite.g:39:5: ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) ^( MONTH_OF_YEAR dow= INT ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: DIRECTION, SEEK, dow, SEEK_BY, INT, MONTH_OF_YEAR
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
					...
					{
						// com/joestelmach/natty/generated/TreeRewrite.g:40:10: ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR $dow) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:40:39: ^( MONTH_OF_YEAR $dow)
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
					...
					break;
				case 4 :
					// com/joestelmach/natty/generated/TreeRewrite.g:42:5: ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) amount= INT ^( MONTH_OF_YEAR dow= INT ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: DIRECTION, SEEK, amount, SEEK_BY, dow, MONTH_OF_YEAR
					...
					{
						// com/joestelmach/natty/generated/TreeRewrite.g:43:10: ^( SEEK DIRECTION SEEK_BY $amount ^( MONTH_OF_YEAR $dow) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:43:43: ^( MONTH_OF_YEAR $dow)
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_MONTH_OF_YEAR.nextNode()
					...
					break;
				case 5 :
					// com/joestelmach/natty/generated/TreeRewrite.g:45:5: ^( SEEK DIRECTION SEEK_BY INT SPAN amt= INT span= SPAN )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: span, amt, SEEK_BY, SEEK, DIRECTION
					...
					{
						// com/joestelmach/natty/generated/TreeRewrite.g:46:10: ^( SEEK DIRECTION SEEK_BY $amt $span)
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
					...
					break;
				case 6 :
					// com/joestelmach/natty/generated/TreeRewrite.g:49:5: ^( RELATIVE_DATE ^( SEEK dir= DIRECTION seekby= SEEK_BY day= INT ^( MONTH_OF_YEAR month= INT ) ) ^( EXPLICIT_SEEK amount= INT ^( DAY_OF_WEEK dow= INT ) ) ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: MONTH_OF_YEAR, YEAR_OF, amount, dow, EXPLICIT_SEEK, dir, RELATIVE_DATE, year, seekby, day, EXPLICIT_SEEK, DAY_OF_WEEK, SEEK, month
					...
					{
						// com/joestelmach/natty/generated/TreeRewrite.g:54:8: ^( RELATIVE_DATE ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) ) ^( EXPLICIT_SEEK ^( YEAR_OF $year) ) ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) ) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_RELATIVE_DATE.nextNode()
						, root_1);
						// com/joestelmach/natty/generated/TreeRewrite.g:54:24: ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) )
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:54:49: ^( MONTH_OF_YEAR $month)
						{
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:55:8: ^( EXPLICIT_SEEK ^( YEAR_OF $year) )
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_EXPLICIT_SEEK.nextNode()
						, root_2);
						// com/joestelmach/natty/generated/TreeRewrite.g:55:24: ^( YEAR_OF $year)
						{
						CommonTree root_3 = (CommonTree)adaptor.nil();
						root_3 = (CommonTree)adaptor.becomeRoot(
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:56:8: ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) )
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_EXPLICIT_SEEK.nextNode()
						...
						// com/joestelmach/natty/generated/TreeRewrite.g:56:32: ^( DAY_OF_WEEK $dow)
						{
						CommonTree root_3 = (CommonTree)adaptor.nil();
						root_3 = (CommonTree)adaptor.becomeRoot(
						stream_DAY_OF_WEEK.nextNode()
