package za.org.grassroot.core.util.natty.src.main.java.com.joestelmach.natty;
...
import za.org.grassroot.core.util.natty.src.main.java.com.joestelmach.natty.generated.DateLexer;
import za.org.grassroot.core.util.natty.src.main.java.com.joestelmach.natty.generated.DateParser;
import za.org.grassroot.core.util.natty.src.main.java.com.joestelmach.natty.generated.DateWalker;
import za.org.grassroot.core.util.natty.src.main.java.com.joestelmach.natty.generated.TreeRewrite;
...
public class Parser {
   ...
   */
  public Parser() {
    _logger.info("Inside the constructor of the parser that resides");
  ...
  private DateGroup singleParse(TokenStream stream, String fullText, Date referenceDate) {
    ...
    try {
      ...
      if(tree.getChildCount() > 0) {
        _logger.info("ABOUT TO PARSE THE STREAM AND WALK IT: " + tokenString.toString());
  ...
  private List<TokenStream> collectTokenStreams(TokenStream stream) {
    ...
    _logger.info("ABOUT TO COLLECT TOKENS FROM THIS STREAM: " + tokenString.toString());
    List<TokenStream> streams = new ArrayList<TokenStream>();
    for(List<Token> group:groups) {
      if(!group.isEmpty()) {
        StringBuilder builder = new StringBuilder();
        builder.append("BUILDING A GROUP OF TOKENS: ");
