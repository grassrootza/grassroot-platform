...
public class UserRepositoryTest {
    ...
    public void shouldAddAndRemoveMappedMembership() {
        ...
        Membership newMember = new Membership(group, user, role, Instant.now(), GroupJoinMethod.ADDED_BY_ADMIN);
    ...
    public void shouldFetchMemberships() {
        ...
        Membership newMember = new Membership(group, userMember, role, Instant.now(), GroupJoinMethod.ADDED_BY_ADMIN);
    ...
    public void shouldReturnUserThatRSVPYes() {
        ...
        group.addMember(u2, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_ADMIN);
    ...
    public void shouldFindUsersByStringsAndGroup() {
        ...
        testGroup.addMember(user1, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_ADMIN);
        testGroup.addMember(user2, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_ADMIN);
    ...
    public void shouldFindGroupMembersExcludingCreator() {
        ...
        testGroup.addMember(testUser, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_ADMIN);
        testGroup.addMember(user2, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_ADMIN);
        testGroup.addMember(user3, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_ADMIN);
