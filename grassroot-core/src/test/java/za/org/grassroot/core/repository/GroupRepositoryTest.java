...
public class GroupRepositoryTest {
    ...
    public void shouldAddRole() {
        ...
        assertTrue(groupToCreate.getMembership(userRole).getRole().equals(RoleName.ROLE_COMMITTEE_MEMBER));
        assertTrue(groupToCreate.getMembership(userRole1).getRole().equals(RoleName.ROLE_ORDINARY_MEMBER));
        assertTrue(groupToCreate.getMembership(userRole2).getRole().equals(RoleName.ROLE_GROUP_ORGANIZER));
