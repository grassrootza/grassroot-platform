...
//    private GroupBroker groupBroker;
    ...
    public void copyMembersIntoGroup(String userUid, String groupUid, Set<String> memberUids) {
        ...
        group.addMembers(userSet, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_GROUP_ADMIN);


        // recursively add users to all parent groups
        Group parentGroup = group.getParent();
        while (parentGroup != null) {
            parentGroup.addMembers(userSet, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_GROUP_ADMIN);
    ...
    public void addMemberViaJoinCode(String userUidToAdd, String groupUid, String tokenPassed) {
        ...
        Group parentGroup = group.getParent();
        while (parentGroup != null) {
            parentGroup.addMember(user, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_GROUP_ADMIN);
            parentGroup = parentGroup.getParent();
        }
...
//                .collect(Collectors.toMap(MembershipInfo::getPhoneNumberWithCCode, m -> m));
        ...
        for (MembershipInfo membershipInfo : validNumberMembers) {
            ...
            Membership membership = group.addMember(user, roleName, GroupJoinMethod.ADDED_BY_GROUP_ADMIN);
            if (membership != null) {
