...
if [[ ! -f .clean ]]; then
  ...
  java -Djava.security.egd=file:/dev/urandom -Dspring.profiles.active=$PROFILE,fast -jar -Xmx1024m grassroot-webapp/build/libs/grassroot-webapp-1.1.0.3.jar > log/grassroot-app.log 2>&1 &
fi
