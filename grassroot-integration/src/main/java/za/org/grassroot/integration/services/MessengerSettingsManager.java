...
public class MessengerSettingsManager implements MessengerSettingsService {
    ...
    @Override
    @Transactional
    public void updateUserGroupMessageSettings(String userUid, String groupUid, boolean active, boolean canSend, boolean canReceive, Instant reactivationTime) throws Exception{
    ...
    public boolean isCanSend(String userUid, String groupUid) throws Exception {
        Objects.nonNull(userUid);
        Objects.nonNull(groupUid);
    ...
    public List<MessengerSettings> loadMutedUsersMessengerSettings(){
        return  messengerSettingsRepository.findByActiveAndUserInitiatedAndCanSendAndReactivationTimeBefore(true,false,false, Instant.now());
