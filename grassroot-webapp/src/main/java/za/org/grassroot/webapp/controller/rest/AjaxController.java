...
import za.org.grassroot.webapp.model.rest.AutoCompleteResponse;
...
public class AjaxController extends BaseController {
    ...
    @Autowired
    public AjaxController(GroupQueryBroker groupQueryBroker, TaskBroker taskBroker, GeoLocationBroker geoLocationBroker) {
