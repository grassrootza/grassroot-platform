CREATE OR REPLACE FUNCTION getusergroupswithsize(IN userid bigint)
  RETURNS TABLE(id bigint, uid text,created_date_time timestamp without time zone, name character varying, active boolean, group_size integer) AS
$BODY$
DECLARE
  mem_rec RECORD;
  group_rec RECORD;
