...
update paid_account set free_form_per_month = 200 where account_type = 'LIGHT';
update paid_account set free_form_per_month = 500 where account_type = 'STANDARD';
update paid_account set free_form_per_month = 2000 where account_type = 'HEAVY';
update paid_account set free_form_per_month = 10000 where account_type = 'ENTERPRISE';
