...
ALTER TABLE event ALTER COLUMN applies_to_group SET NOT NULL;
...
ALTER TABLE event_request ALTER COLUMN applies_to_group SET NOT NULL;
...
ALTER TABLE log_book_request ALTER COLUMN group_id SET NOT NULL;
