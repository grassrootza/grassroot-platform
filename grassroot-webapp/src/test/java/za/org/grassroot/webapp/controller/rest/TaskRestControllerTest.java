...
public class TaskRestControllerTest extends RestAbstractUnitTest {
    ...
    public void gettingTasksShouldWork() throws Exception {
        ...
        when(taskBrokerMock.fetchGroupTasks(sessionTestUser.getUid(), testGroup.getUid(), false, TodoStatus.BOTH)).
                thenReturn(taskList);
        ...
        verify(taskBrokerMock, times(1)).fetchGroupTasks(sessionTestUser.getUid(), testGroup.getUid(), false, TodoStatus.BOTH);
    }
