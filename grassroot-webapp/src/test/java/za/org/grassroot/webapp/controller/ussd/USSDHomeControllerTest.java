...
public class USSDHomeControllerTest extends USSDAbstractUnitTest {
    ...
    public void voteRequestScreenShouldWorkInAllLanguages() throws Exception {
        ...
        testGroup.addMember(testUser, BaseRoles.ROLE_GROUP_ORGANIZER, GroupJoinMethod.ADDED_BY_GROUP_ADMIN);
        ...
        for (User user : votingUsers) {
            ...
            testGroup.addMember(user, BaseRoles.ROLE_ORDINARY_MEMBER, GroupJoinMethod.ADDED_BY_GROUP_ADMIN); // this may be redundant
