...
public class TimeZoneTest extends AbstractTest {
  ...
  public void testSpecific() throws Exception {
    Date reference = sdfWithTime.parse("19/5/2012 12:00 am");
    calendarSource = new CalendarSource(reference);

    /*validateDateTime(reference, "2011-06-17T07:00:00Z", 17, 6, 2011, 3, 0, 0);
    validateDateTime(reference, "05-Aug-2013 14:10:56 UTC", 5, 8, 2013, 10, 10, 56);
