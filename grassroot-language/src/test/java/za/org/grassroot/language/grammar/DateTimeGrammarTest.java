...
public class DateTimeGrammarTest extends AbstractGrammarTest {
  ...
  public void date_time_alternative() throws Exception {
    ...
    assertAST("feb 28th or 2 days after", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 28) (MONTH_OF_YEAR 2))) (DATE_TIME (RELATIVE_DATE (SEEK > by_day 2 (EXPLICIT_DATE (DAY_OF_MONTH 28) (MONTH_OF_YEAR 2))))))");
    assertAST("january fourth or the friday after", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 4) (MONTH_OF_YEAR 1))) (DATE_TIME (RELATIVE_DATE (SEEK > by_day 1 (DAY_OF_WEEK 6) (EXPLICIT_DATE (DAY_OF_MONTH 4) (MONTH_OF_YEAR 1))))))");
    assertAST("10/10/2008 or 12/10/2008", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 10) (MONTH_OF_YEAR 10) (YEAR_OF 2008))) (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 12) (MONTH_OF_YEAR 10) (YEAR_OF 2008))))");
    ...
    assertAST("10/10 or 30/12 or 15/10 at 5pm", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 10) (MONTH_OF_YEAR 10))) (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 30) (MONTH_OF_YEAR 12))) (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 15) (MONTH_OF_YEAR 10)) (EXPLICIT_TIME (HOURS_OF_DAY 5) (MINUTES_OF_HOUR 0) pm)))");
    ...
    assertAST("26 oct 10:00 am to 11:00 am", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 26) (MONTH_OF_YEAR 10)) (EXPLICIT_TIME (HOURS_OF_DAY 10) (MINUTES_OF_HOUR 00) am)) (DATE_TIME (EXPLICIT_TIME (HOURS_OF_DAY 11) (MINUTES_OF_HOUR 00) am)))");
    assertAST("jan 1 to 2", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 1))) (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 2) (MONTH_OF_YEAR 1))))");
    assertAST("16:00 nov 6 to 17:00", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 6) (MONTH_OF_YEAR 11)) (EXPLICIT_TIME (HOURS_OF_DAY 16) (MINUTES_OF_HOUR 00))) (DATE_TIME (EXPLICIT_TIME (HOURS_OF_DAY 17) (MINUTES_OF_HOUR 00))))");
    assertAST("may 2nd to 5th", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 2) (MONTH_OF_YEAR 5))) (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 5) (MONTH_OF_YEAR 5))))");
    assertAST("6am dec 5 to 7am", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 5) (MONTH_OF_YEAR 12)) (EXPLICIT_TIME (HOURS_OF_DAY 6) (MINUTES_OF_HOUR 0) am)) (DATE_TIME (EXPLICIT_TIME (HOURS_OF_DAY 7) (MINUTES_OF_HOUR 0) am)))");
    assertAST("3/1 to 3/2", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 3) (MONTH_OF_YEAR 1))) (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 3) (MONTH_OF_YEAR 2))))");
    assertAST("3/2 to in 1 week", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 3) (MONTH_OF_YEAR 2))) (DATE_TIME (RELATIVE_DATE (SEEK > by_day 1 week))))");
    assertAST("first day of may to last day of may", "(DATE_TIME_ALTERNATIVE (DATE_TIME (RELATIVE_DATE (EXPLICIT_SEEK (DAY_OF_MONTH 1)) (SEEK > by_day 0 (MONTH_OF_YEAR 5)))) (DATE_TIME (RELATIVE_DATE (EXPLICIT_SEEK (DAY_OF_MONTH 31)) (SEEK > by_day 0 (MONTH_OF_YEAR 5)))))");
  }
  ...
  public void date_time() throws Exception {
    ...
    assertAST("1st oct in the year '89 1300 hours", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 89)) (EXPLICIT_TIME (HOURS_OF_DAY 13) (MINUTES_OF_HOUR 00)))");
    assertAST("1st oct in the year '89 at 1300 hours", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 89)) (EXPLICIT_TIME (HOURS_OF_DAY 13) (MINUTES_OF_HOUR 00)))");
    assertAST("1st oct in the year '89, 13:00", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 89)) (EXPLICIT_TIME (HOURS_OF_DAY 13) (MINUTES_OF_HOUR 00)))");
    assertAST("1st oct in the year '89,13:00", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 89)) (EXPLICIT_TIME (HOURS_OF_DAY 13) (MINUTES_OF_HOUR 00)))");
    assertAST("1st oct in the year '89, at 13:00", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 89)) (EXPLICIT_TIME (HOURS_OF_DAY 13) (MINUTES_OF_HOUR 00)))");
    assertAST("3am on oct 1st 2010", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 2010)) (EXPLICIT_TIME (HOURS_OF_DAY 3) (MINUTES_OF_HOUR 0) am))");
    assertAST("3am, october first 2010", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 2010)) (EXPLICIT_TIME (HOURS_OF_DAY 3) (MINUTES_OF_HOUR 0) am))");
    assertAST("3am,october first 2010", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 2010)) (EXPLICIT_TIME (HOURS_OF_DAY 3) (MINUTES_OF_HOUR 0) am))");
    assertAST("3am, on october first 2010", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 2010)) (EXPLICIT_TIME (HOURS_OF_DAY 3) (MINUTES_OF_HOUR 0) am))");
    assertAST("3am october first 2010", "(DATE_TIME (EXPLICIT_DATE (DAY_OF_MONTH 1) (MONTH_OF_YEAR 10) (YEAR_OF 2010)) (EXPLICIT_TIME (HOURS_OF_DAY 3) (MINUTES_OF_HOUR 0) am))");
    ...
    assertAST("the 28th of the month after next", "(DATE_TIME (RELATIVE_DATE (EXPLICIT_SEEK (DAY_OF_MONTH 28)) (SEEK > by_day 2 month)))");
    ...
    assertAST("final thursday in april", "(DATE_TIME (RELATIVE_DATE (EXPLICIT_SEEK 5 (DAY_OF_WEEK 5)) (SEEK > by_day 0 (MONTH_OF_YEAR 4))))");
    assertAST("final thurs in sep", "(DATE_TIME (RELATIVE_DATE (EXPLICIT_SEEK 5 (DAY_OF_WEEK 5)) (SEEK > by_day 0 (MONTH_OF_YEAR 9))))");
