...
public abstract class AbstractTest {
  ...
  protected void validateDateTime(Date referenceDate, String value, int month, int day, int year,
      ...
      System.out.println("Trying to parse string: " + value);
  ...
  protected void validateDateTime(Date date, int month, int day, int year, 
      ...
      System.out.println(String.format("Date passed, back as: %s, expecting month %d and day %d",
                                       date.toInstant().toString(), month, day));
